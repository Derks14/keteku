...
export const Route = createFileRoute("/_layout/projects_/details/update/$id")({
...
function RouteComponent() {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (updatedData: DetailValidationSchema) =>
      DetailService.updateDetail({ detailId: params.id, detail: updatedData }),
  ...
  const onSubmit = (data: DetailValidationSchema) => {
    mutate(data);
  };
      ...
      <Card className="overflow-hidden">
        ...
        <form className="space-y-6 p-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select value={field.value} onValueChange={field.onChange}>
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Choose detail status" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectGroup>
              ...
              />
              <InputDescription
                activator={!!errors.status}
                default_message="Pick the detail status."
          ...
          <Button type="submit" className="w-full" disabled={isPending}>
            {isPending ? "Saving..." : "Update Detail"}
          </Button>
        </form>
      </Card>
